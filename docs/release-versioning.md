...
The frontend package version `1.0.0` belongs to its existing independent asset metadata. Native build flags consume the overlaid VERSION file; the Linux build smoke checks the actual executable version.
